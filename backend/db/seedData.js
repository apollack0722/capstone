  ...
  async function createInitialMedia() {
    try {
      ...
      const mediaToCreate = [
        ...
        { title: 'The Big Lebowski', description: 'Jeff "The Dude" Lebowski, mistaken for a millionaire of the same name, seeks restitution for his ruined rug and enlists his bowling buddies to help get it.', genre: 'Comedy', 'rentalPrice': 7.99, rating: 'R', 'imgUrl': 'https://xl.movieposterdb.com/09_02/1998/118715/xl_118715_e3aa6190.jpg'},
